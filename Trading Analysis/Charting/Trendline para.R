...
daily.output = daily.result[,c(5,3,6,2,7,1)]
colnames(daily.output) = c("sup1","res1","sup2","res2","sup3","res3")
daily.output[is.na(daily.output)] <- 0

write.csv(daily.output,"daily_levels.csv")
